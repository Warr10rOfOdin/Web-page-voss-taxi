          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl p-8 shadow-md">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  '/images/20241014_140924.jpg',
                  '/images/20240604_211019.jpg',
                  '/images/20240526_111711.jpg',
                  '/images/20230901_141216.jpg'
                ].map((img, i) => (
                  <div key={i} className="aspect-video rounded-lg overflow-hidden">
                    <img src={img} alt={`Tvindefossen ${i + 1}`} className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
                  </div>
                ))}
              </div>
            </div>
