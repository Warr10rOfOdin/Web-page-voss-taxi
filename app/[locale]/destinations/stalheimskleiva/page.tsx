    ...
    <div className="py-16 md:py-24 bg-gradient-to-b from-white to-taxi-light-grey">
      <Container>
        ...
        <div className="relative h-96 rounded-2xl overflow-hidden mb-12">
          <img
            src="/images/20230509_190808.jpg"
            alt="Stalheimskleiva"
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl p-8 shadow-md">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  '/images/20230509_190808.jpg',
                  '/images/20240315_122332.jpg',
                  '/images/20240910_123244.jpg',
                  '/images/20230907_151359.jpg'
                ].map((img, i) => (
                  <div key={i} className="aspect-video rounded-lg overflow-hidden">
                    <img src={img} alt={`Stalheimskleiva ${i + 1}`} className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
                  </div>
                ))}
              </div>
            </div>
