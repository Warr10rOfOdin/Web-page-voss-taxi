    ...
    <div className="py-16 md:py-24 bg-gradient-to-b from-white to-taxi-light-grey">
      <Container>
        ...
        <div className="relative h-96 rounded-2xl overflow-hidden mb-12">
          <img
            src="/images/20230104_085911.jpg"
            alt="Molstertunet"
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl p-8 shadow-md">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  '/images/20230104_085911.jpg', '/images/20251003_214335.jpg', '/images/IMG_20211231_050221_808.jpg', '/images/20240526_111711.jpg'
                ].map((img, i) => (
                  <div key={i} className="aspect-video rounded-lg overflow-hidden">
                    <img src={img} alt={`Molstertunet ${i + 1}`} className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" />
                  </div>
                ))}
              </div>
            </div>
